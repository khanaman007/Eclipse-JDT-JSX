...
case 802 : if (DEBUG) { System.out.println("JSXElement ::= JSXSelfClosingElement JSXOpeningElement"); }  //$NON-NLS-1$
    //consumeJSXElement();  
	break;

case 803 : if (DEBUG) { System.out.println("JSXClosingElement ::= LESS DIVIDE JSXElementName..."); }  //$NON-NLS-1$
   // consumeJSXClosingElement();  
	break;

case 805 : if (DEBUG) { System.out.println("JSXOpeningElement ::= LESS JSXElementName..."); }  //$NON-NLS-1$
    //consumeJSXOpeningElement();  
	break;

case 807 : if (DEBUG) { System.out.println("JSXChildrenopt ::="); }  //$NON-NLS-1$
    //consumeJSXChildrenopt();  
	break;

case 810 : if (DEBUG) { System.out.println("JSXChildExpressionopt ::= Expressionopt"); }  //$NON-NLS-1$
  //  JSXChildExpressionopt();  
	break;

case 811 : if (DEBUG) { System.out.println("JSXText ::= JSXTextCharacter JSXTextopt"); }  //$NON-NLS-1$
   // consumeJSXText();  
	break;

case 812 : if (DEBUG) { System.out.println("JSXTextCharacter ::= Identifier LPAREN QUESTION NOT..."); }  //$NON-NLS-1$
   // consumeJSXTextCharacter();  
	break;

case 814 : if (DEBUG) { System.out.println("JSXAttributesopt ::="); }  //$NON-NLS-1$
   // consumeJSXAttributesopt() ;  
	break;

case 820 : if (DEBUG) { System.out.println("JSXNamespacedName ::= JSXIdentifier COLON JSXIdentifier"); }  //$NON-NLS-1$
   // consumeJSXNamespacedName();  
	break;

case 828 : if (DEBUG) { System.out.println("JSXDoubleStringCharactersopt ::="); }  //$NON-NLS-1$
   // consumeJSXDoubleStringCharactersopt();  
	break;

case 832 : if (DEBUG) { System.out.println("JSXSingleStringCharactersopt ::="); }  //$NON-NLS-1$
  //  consumeJSXSingleStringCharactersopt();  
	break;

case 836 : if (DEBUG) { System.out.println("JSXAttributeInitializeropt ::="); }  //$NON-NLS-1$
   // consumeJSXAttributeInitializeropt();  
	break;
